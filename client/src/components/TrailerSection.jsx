...
const TrailerSection = () => {
  const [curenttrailer,setcuutrail]= useState(dummyTrailers[0])
  console.log(curenttrailer.videoUrl)
    return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden'>
        ...
        <div className='relative mt-6'>
            ...
            {/* <ReactPlayer 
  url={curenttrailer.videoUrl} 
  controls={true}
  playing={true} // Auto-starts
  muted={true}   // Required by most browsers for auto-start
  width="100%" 
  height="100%"
/> */}
            <ReactPlayer src={curenttrailer.videoUrl} controls={false}
